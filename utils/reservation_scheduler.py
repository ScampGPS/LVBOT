...
from utils.booking_orchestrator import DynamicBookingOrchestrator
from utils.browser_allocation import BrowserAllocationHelper
from utils.browser_refresh_manager import BrowserRefreshManager
from utils.tennis_executor import TennisExecutor, create_tennis_config_from_user_info
from utils.async_booking_executor import AsyncBookingExecutor
from utils.browser_health_checker import BrowserHealthChecker, HealthStatus
from utils.browser_pool_recovery import BrowserPoolRecoveryService
...
class ReservationScheduler:
    ...
    async def _initialize_browser_pool(self):
        ...
        try:
            ...
            if self.browser_pool:
                ...
                # Set global browser pool for smart executor
                # from utils.smart_tennis_executor import set_global_browser_pool
    ...
    async def _execute_single_booking(self, assignment: Dict, reservation: Dict, target_date: datetime, index: int, total: int) -> Dict:
        ...
        try:
            ...
            if self.browser_pool:
                ...
                try:
                    from utils.emergency_browser_fallback import EmergencyBrowserFallback
    ...
    def _update_reservation_failed(self, reservation_id: str, error: str):
        ...
        from utils.constants import TEST_MODE_ENABLED
