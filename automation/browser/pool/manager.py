    ...
    async def create_and_navigate_court_page_safe(self, court: int):
        ...
        try:
            ...
            context_kwargs = {
                ...
                # NOTE: Removed extra_http_headers - they were causing CORS violations
                # with third-party resources (reCAPTCHA, Stripe, Google Fonts) which
                # blocked form submission. Chromium sends appropriate headers automatically.
            }
