...
from utils.acuity_booking_form import AcuityBookingForm
...
class SpecializedBrowserPool:
    ...
    def __init__(self, 
        ...
        # Court management
        from utils.court_pool_manager import CourtPoolManager
        from utils.browser_court_switcher import BrowserCourtSwitcher
