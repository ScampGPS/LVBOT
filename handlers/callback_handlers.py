...
from utils.immediate_booking_handler import ImmediateBookingHandler
from utils.constants import COURT_HOURS, get_court_hours
...
class CallbackHandler:
    ...
    def __init__(self, availability_checker, reservation_queue, user_manager, browser_pool=None) -> None:
        ...
        from utils.reservation_tracker import ReservationTracker
    ...
    async def _handle_profile_menu(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        try:
            ...
            from utils.constants import HARDCODED_VIP_USERS, HARDCODED_ADMIN_USERS
    ...
    async def _show_queue_time_selection(self, update: Update, context: ContextTypes.DEFAULT_TYPE, selected_date: date) -> None:
        ...
        from utils.constants import TEST_MODE_ENABLED, TEST_MODE_ALLOW_WITHIN_48H
    ...
    async def _handle_queue_booking_confirm(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        try:
            ...
            from utils.constants import TEST_MODE_ENABLED, TEST_MODE_TRIGGER_DELAY_MINUTES
    ...
    async def _extract_court_times_for_date_cached(self, court_num: int, target_date: date) -> List:
        ...
        try:
            ...
            from utils.time_order_extraction import AcuityTimeParser
            from utils.acuity_page_validator import AcuityPageValidator
