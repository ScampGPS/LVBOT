...
async def monitor_cancel_click():
    ...
    t('archive.scripts.monitoring.monitor_cancel_click_prefilled.monitor_cancel_click')
    async with async_playwright() as p:
        ...
        def log_request(request):
            ...
            t('archive.scripts.monitoring.monitor_cancel_click_prefilled.monitor_cancel_click.log_request')
        ...
        def log_response(response):
            ...
            t('archive.scripts.monitoring.monitor_cancel_click_prefilled.monitor_cancel_click.log_response')
